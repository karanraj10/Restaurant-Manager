package com.project.restaurantmanager.UI.Admin.AccountFragmentModules;
...
public class manage_account_fragment extends Fragment {
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            final View view = inflater.inflate(R.layout.employee_accountsetting_fragment,container, false);

            name = view.findViewById(R.id.emp_acc_manage_name_edit);
            name.setText(MainActivity.sharedPreferences.getName());

            mobile = view.findViewById(R.id.emp_acc_manage_mobile_edit);
            mobile.setText(MainActivity.sharedPreferences.getMobile());

            Button update = view.findViewById(R.id.emp_acc_manage_update_button);
