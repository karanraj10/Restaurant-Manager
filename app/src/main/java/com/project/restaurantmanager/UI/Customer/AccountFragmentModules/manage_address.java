...
public class manage_address extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.customer_accountaddress_fragment,container,false);
        Button update = view.findViewById(R.id.cust_acc_address_update_button);
        address = view.findViewById(R.id.cust_acc_address_edit);
