...
public class change_password extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.employee_changepassword_fragment,container,false);

        Button update = view.findViewById(R.id.emp_acc_changepass_button);

        update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final TextInputEditText password1 = view.findViewById(R.id.emp_acc_changepass_password1_edit);
                final TextInputEditText password2 = view.findViewById(R.id.emp_acc_changepass_password2_edit);
